                        ...
                        <div className="py-12">
                            <div className="max-w-lg lg:max-w-md mx-auto lg:mx-0 mb-8 text-center lg:text-left">
                                <h2 className="text-3xl md:text-4xl mb-4 font-bold font-heading">
                                    <span> The quick </span>
                                    <span className="text-green-600"> brown fox</span>
                            ...
                            <div className="text-center lg:text-left">
                                <a
                                    className="block sm:inline-block py-4 px-8 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-green-600 hover:bg-green-700 rounded"
                                    href="#"
                                >
                                    Check Now
                                </a>
                ...
                <nav className="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto">
                    ...
                    <div>
                        <ul>
                            <li className="mb-1">
                                <a
                                    className="block p-4 text-sm text-gray-500 hover:bg-green-50 hover:text-green-600"
                                    href="#"
                                >
                                    Product
                                </a>
                        ...
                        <div className="mt-4 pt-6 border-t border-gray-100">
                            <a
                                className="block px-4 py-3 mb-3 text-xs text-center font-semibold leading-none bg-green-600 hover:bg-green-700 text-white rounded"
                                href="#"
                            >
                                Sign Up
                            </a>
                            <a
                                className="block px-4 py-3 mb-2 text-xs text-center text-green-600 hover:text-green-700 font-semibold leading-none border border-green-200 hover:border-green-300 rounded"
                                href="#"
                            >
                                Log In
                            </a>
