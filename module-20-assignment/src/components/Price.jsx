            ...
            <div className="container  mx-auto">
                <div className="text-center mb-16">
                    <h2 className="max-w-lg mx-auto mb-4 text-4xl font-bold font-heading">
                        ...
                        <span className="text-green-600">choose</span>
                ...
                <div className="flex flex-wrap -mx-3">
                    <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                        <div className="pt-16 pb-8 px-4 text-center bg-white rounded shadow">
                            ...
                            <span className="text-4xl text-green-600 font-bold font-heading">
                $32.99
              </span>
                            ...
                            <div>
                                <a
                                    className="block sm:inline-block py-4 px-6 mb-4 sm:mb-0 sm:mr-3 text-xs text-white text-center font-semibold leading-none bg-green-600 hover:bg-green-700 rounded"
                                    href="#"
                                >
                                    Start Free Trial
                                </a>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                        <div className="pt-16 pb-8 px-4 text-center text-white bg-gray-800 rounded shadow">
                            ...
                            <div>
                                <a
                                    className="block sm:inline-block py-4 px-6 mb-4 sm:mb-0 sm:mr-3 text-xs text-green-600 text-center font-semibold leading-none bg-white hover:bg-gray-50 rounded"
                                    href="#"
                                >
                                    Start Free Trial
                                </a>
