...
import {read_single_blog__Request__API, update_blog__Request__API,} from "@/utility/api";
            ...
            <Dialog open={open} handler={handleOpen}>
                ...
                <DialogBody>
                    <div className="grid gap-6">
                        <Typography className="-mb-1" color="blue-gray" variant="h6">ID = {blog?.id}</Typography>
                        <Typography className="-mb-1" color="blue-gray" variant="h6">Title</Typography>
                        <input
                ...
                <DialogFooter className="space-x-2">
                    <Button variant="text" color="gray" onClick={handelClose}>cancel</Button>
                    <Button variant="gradient" color="gray" onClick={() => submit(blog?.id)}>Update</Button>
                </DialogFooter>
            </Dialog>
        </>
    );
