                ...
                <div className="grid grid-cols-12 gap-[30px]">
                    {
                        data.map((item, index) => <div key={index} className="col-span-4 px-4 mb-8">
                            <Link className="block max-w-md mx-auto group relative shadow-lg"
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-5">
                                    <div className="p-5 bg-white rounded-xl">
                                        ...
                                        <div
                                            className="hidden group-hover:flex justify-end mt-5 items-center text-orange-900 font-semibold">
