            ...
            Our Team
                ...
                <div className="flex flex-wrap -mx-3">
                    <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12">
                        ...
                        <p className="mt-2 mb-4 text-green-600">CEO</p>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12">
                        ...
                        <p className="mt-2 mb-4 text-green-600">Head of Development</p>
                        <div className="flex py-1 justify-center space-x-2">
                            <img src="metis-assets/icons/facebook.svg" alt=""/>
                            <img src="metis-assets/icons/twitter.svg" alt=""/>
                        </div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12">
                        ...
                        <p className="mt-2 mb-4 text-green-600">Head of Operations</p>
                        <div className="flex py-1 justify-center space-x-2">
                            <img src="metis-assets/icons/facebook.svg" alt=""/>
                            <img src="metis-assets/icons/twitter.svg" alt=""/>
                        </div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12">
                        ...
                        <p className="mt-2 mb-4 text-green-600">Senior Developer</p>
                        <div className="flex py-1 justify-center space-x-2">
                            <img src="metis-assets/icons/facebook.svg" alt=""/>
                            <img src="metis-assets/icons/twitter.svg" alt=""/>
                        </div>
                    ...
                    <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-12">
                        ...
                        <p className="mt-2 mb-4 text-green-600">Junior Developer</p>
                        <div className="flex py-1 justify-center space-x-2">
                            <img src="metis-assets/icons/facebook.svg" alt=""/>
                            <img src="metis-assets/icons/twitter.svg" alt=""/>
                        </div>
