...
export default function page() {
    ...
    return (
        <>
            ...
            <section className="py-12 bg-green-100 h-screen flex justify-center items-center">
                <div className="container  mx-auto">
                    <div className="flex max-w-md mx-auto flex-col text-center">
                        <a className="block mx-auto text-white text-3xl font-semibold leading-none" href="/">
                        ...
                        <form onSubmit={handelSubmit} className="mt-12 mb-8 p-8 bg-white rounded">
                            ...
                            <button
                                type="submit"
                                className="block w-full p-4 text-center text-xs text-white font-semibold leading-none bg-green-600 hover:bg-green-700 rounded"
                            >
                                Sign In
                            </button>
                        </form>
                        <div>
                            <p className="text-xs text-green-200 text-center">
                                <a className="underline hover:text-green-100" href="/privacy">Police privacy</a>
                                {" "} and {" "}
                                <a className="underline hover:text-green-100" href="/terms"> Terms of Use</a>
                            </p>
                        </div>
                    </div>
                </div>
