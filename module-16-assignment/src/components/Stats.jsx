import StatListApi from "@/src/lib/StatListApi";

const Stats = async () => {
    const stat = await StatListApi()
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap">
                    <div className="mb-8 w-full md:w-1/2 lg:w-1/4 text-center">
                        ...
                        <h3 className="text-2xl font-bold">{stat.followers}</h3>
                    ...
                    <div className="mb-8 w-full md:w-1/2 lg:w-1/4 text-center">
                        ...
                        <h3 className="text-2xl font-bold">{stat.solved}</h3>
                    ...
                    <div className="mb-8 w-full md:w-1/2 lg:w-1/4 text-center">
                        ...
                        <h3 className="text-2xl font-bold">{stat.customers}</h3>
                    ...
                    <div className="mb-8 w-full md:w-1/2 lg:w-1/4 text-center">
                        ...
                        <h3 className="text-2xl font-bold">{stat.projects}</h3>
